...
import cn.yjh.anotation.Autowired;
            ...
            for (Field field: fields) {
                ...
                try {
                    ...
                    if(clazz.isInterface()){
                        for (Map.Entry<String,Object> entry1: iocMap.entrySet()) {
                            if(clazz.isAssignableFrom(entry1.getValue().getClass())){
                                o = entry1.getValue();
                                break;
                            }
                        }
                    }else{
                        o= iocMap.get(beanName);
                    }
                    if(o!=null){
